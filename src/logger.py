...
logs_path=os.path.join(os.getcwd(),"logs",LOG_FILE)   # Path to the logs directory
...
)    # Configure logging to write to the log file with the specified format and level